...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // Initialize click count from session storage if it exists
    const storedClickCount = sessionStorage.getItem('nameClickCount');
    if (storedClickCount) {
  ...
  const handleNameClick = (e: React.MouseEvent) => {
    ...
    // Store click count in session storage for Easter egg tracking
    sessionStorage.setItem('nameClickCount', newClickCount.toString());
